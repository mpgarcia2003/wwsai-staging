...
// Fixed relative import from '../LanguageContext' to './LanguageContext'
...
const Visualizer: React.FC<VisualizerProps> = ({
  ...
  useEffect(() => {
    if (selectedFabric) {
      ...
      img.src = getFabricUrl(selectedFabric.cloudinaryId, 'texture');
      img.onload = () => {
        const seamlessCanvas = createSeamlessTile(img);
        setFabricPatternImage(seamlessCanvas);
      };
      img.onerror = () => setFabricPatternImage(null);
    } else {
